...
if __name__ == "__main__":
    ...
    logger = configure("../outcomes/tensorboard_log/reach", ["stdout", "tensorboard"])
    random_path = "random" if random_env else "static"
    file_path = "../outcomes/models/sac_reach_noexp_ctrlaction_model_" + random_path
    ...
    model.learn(total_timesteps=total_steps, eval_env=env, eval_freq=5000, eval_log_path="../outcomes/evaluation/reach")
